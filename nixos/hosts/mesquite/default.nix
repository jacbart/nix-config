...
}:
{
  ...
  # The i211 NICs have a single RX/TX queue each, so we use RPS to
  # distribute softIRQ processing across CPU cores.
  # Strategy: pin HW IRQs to core 3 (bitmask 8), distribute RPS to cores 0-2 (bitmask 7).
